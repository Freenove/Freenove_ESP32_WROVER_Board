...
Open "Thonny", click "This computer"  ->  "D:"  ->  "Micropython_Codes"  ->  "3.1_Station_mode" and double click "Station_mode.py". 
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/3.1_Station_mode/Station_mode.py
    :language: python
    :dedent:
...
Open "Thonny", click "This computer"  ->  "D:"  ->  "Micropython_Codes"  ->  "3.2_AP_mode". and double click "AP_mode.py". 
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/3.2_AP_mode/AP_mode.py
    :language: python
    :dedent:
...
Open "Thonny", click "This computer"  ->  "D:"  ->  "Micropython_Codes"  ->  "3.3_AP+STA_mode"and double click "AP+STA_mode.py". 
